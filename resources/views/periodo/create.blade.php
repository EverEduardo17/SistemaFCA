    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('periodo.store') }}" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input name="NombrePeriodo" type="text" class="form-control @error('NombrePeriodo') is-invalid @enderror">
            </div>
            <div class="form-group">
                <label name="FechaInicioPerido">Inicio del Periodo:</label>
                <input type="date" name="FechaInicioPerido" class="form-control @error('FechaInicioPerido') is-invalid @enderror"></input>
            </div>

            <div class="form-group">
                <label name="FechaFinPerido">Término del Periodo:</label>
                <input type="date" name="FechaFinPerido" class="form-control @error('FechaFinPerido') is-invalid @enderror"></input>
            </div>
