...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a class="btn btn-outline-info float-right px-6 mb-3" href="{{ route('cohortes.mostrarTraslados', [$grupos[0]->cohorte->NombreCohorte, $grupos[0]->IdGrupo]) }}" role="button">Ver Traslados</a>


        <div class="table-responsive-xl">
            <table class="table table-striped table-hover table-bordered" id="table_sede">
                <caption>Estudiantes egresados registrados en el sistema para el grupo {{$grupos[0]->NombreGrupo}} del cohorte {{$grupos[0]->cohorte->NombreCohorte}}.</caption>
            ...
            <table class="table table-striped table-hover" id="table_periodos">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border-right">{{$resultados[$modalidad->IdModalidad][0] + $resultados[$modalidad->IdModalidad][1]}}</td>
                    </tr>
                    @else
                    <th scope="row" class="border-right">{{$modalidad->NombreModalidad}}</th>
                    <td class="border-right">0</td>
                    ...
                    @endforeach
                    <tr>
                        <th scope="col" colspan="3" class="text-align-right"><strong>Total de Estudiantes Egresados</strong></th>
