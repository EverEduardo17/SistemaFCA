...
<div class="card">
    ...
    <h5 class="pt-0 mt-0 contenedor-botones text-muted">{{$grupos[0]->NombreGrupo}}</h5>
        ...
        <a class="btn btn-outline-info float-right px-6 mb-3" href="{{ route('cohortes.mostrarBajas', [$grupos[0]->cohorte->NombreCohorte, $grupos[0]->IdGrupo]) }}" role="button">Ver Bajas</a>
