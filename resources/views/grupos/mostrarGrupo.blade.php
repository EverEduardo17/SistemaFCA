...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">{{$grupos[0]->NombreGrupo}}</li>
    </ol>
</nav>
@endsection
@section('content')
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row justify-content-center  mt-3">
            <a class="btn btn-info px-6 mb-3"
        ...
        <a class="btn btn-outline-success float-right mb-3"
            href="{{ route('cohortes.imprimirGrupo', [$grupos[0]->cohorte->NombreCohorte, $nombreGrupo]) }}"
            target="_blank" role="button"><em class="fas fa-save"></em> Guardar PDF</a>

        <div class="table-responsive-xl">
            <table class="table table-striped table-hover table-bordered" id="table_sede" style="border-radius: 1em">
    ...
    var barChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [{{ $activoHombre}},{{ $activoMujer }},{{ $egresadoHombre }},{{ $egresadoMujer }},{{ $entranteHombre }},{{ $entranteMujer }},{{ $salienteHombre }}, {{ $salienteMujer }},{{ $bajaHombre }},{{ $bajaMujer }}],
                backgroundColor: [
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(255, 99, 132, 0.2)'
