...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('cohortes.mostrarGrupo', [$grupos[0]->cohorte->NombreCohorte, $nombreGrupo]) }}">{{$nombreGrupo}}</a></li>
        <li class="breadcrumb-item"><a  href="{{ route('cohortes.mostrarReprobados', [$grupos[0]->cohorte->NombreCohorte, $nombreGrupo]) }}">Reprobados</a></li>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a class="btn btn-outline-dark float-left px-6 mb-3" href="{{ route('cohortes.mostrarReprobados', [$grupos[0]->cohorte->NombreCohorte, $nombreGrupo]) }}" role="button"><em class="fas fa-arrow-left"></em> Regresar</a>
            ...
            <table class="table table-striped table-hover table-bordered" id="table_periodo">
                ...
                <thead class="bg-table">
                    <tr class="text-white">
                        ...
                        <th scope="col">Periodo reprobado</th>
                    </tr>
                </thead>
                <tbody>
