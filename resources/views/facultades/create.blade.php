        ...
        <div class="card-body">
            <form method="POST" action="{{ route('facultades.store') }}" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input name="NombreFacultad" type="text" class="form-control @error('NombreFacultad') is-invalid @enderror" value="{{ old('NombreFacultad') }}">
                </div>
                <div class="form-group">
                    <label name="ClaveFacultad">Clave de la Facultad:</label>
                    <input name="ClaveFacultad" value="{{ old('ClaveFacultad') }}" class="form-control @error('ClaveFacultad') is-invalid @enderror" maxlength="10"></input>
                </div>
