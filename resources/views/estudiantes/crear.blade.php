...
<div class="card">
    <div class="card-header">
        <div class="row">
            <h5 class="card-title col-8"><strong>Agregar estudiante al grupo "{{$grupo->NombreGrupo}}" del cohorte "{{$grupo->cohorte->NombreCohorte}}"</strong></h5>
            <a class="btn btn-outline-info col-4" href="{{ route('estudiantesGrupo', $grupo->IdGrupo) }}" role="button">Ver Estudiantes</a>
        </div>
    </div>
    <div class="card-body">
                ...
                <div class="form-group">
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input name="NombreCohorte" type="text" class="form-control @error('NombreCohorte') is-invalid @enderror" value="{{$cohorte->NombreCohorte}}" placeholder="Ej. S170" disabled></input>
                            <input name="IdCohorte" type="hidden" class="form-control @error('IdCohorte') is-invalid @enderror" value="{{$cohorte->IdCohorte}}"></input>
                        </div>
                        <div class="col">
                ...
                <div class="form-group">
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input name="NombreProgramaEducativo" type="text" class="form-control @error('NombreProgramaEducativo') is-invalid @enderror" value="{{$programaEducativo->NombreProgramaEducativo}}" disabled>
                            <input name="IdProgramaEducativo" type="hidden" class="form-control @error('IdProgramaEducativo') is-invalid @enderror" value="{{$programaEducativo->IdProgramaEducativo}}">
                        </div>
                        <div class="col">
                            <label name="IdGrupo">Grupo de pertenencia:</label>
                            <input name="NombreGrupo" type="text" class="form-control @error('NombreGrupo') is-invalid @enderror" value="{{$grupo->NombreGrupo}}" placeholder="Ej. LIS 701" disabled>
                            <input name="IdGrupo" type="hidden" class="form-control @error('IdGrupo') is-invalid @enderror" value="{{$grupo->IdGrupo}}" placeholder="Ej. LIS 701">
                        </div>
                    </div>
                </div>
