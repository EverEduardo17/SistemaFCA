      ...
      <div class="form-row">
        <div class="col">
          ...
          <input name="TipoEmpresa" type="text" class="form-control @error('TipoEmpresa') is-invalid @enderror"
           value="{{old('TipoEmpresa', $empresa->TipoEmpresa)}}" placeholder="Ej. Público" 
           disabled id="TipoEmpresa">
        </div>
        <div class="col">
          <label for="ActividadEmpresa">Actividad de la empresa:</label>
          <input name="ActividadEmpresa" type="text" class="form-control @error('ActividadEmpresa') is-invalid @enderror" 
          value="{{old('ActividadEmpresa', $empresa->ActividadEmpresa)}}" placeholder="Ej. Comercio" 
          disabled id="ActividadEmpresa">
        </div>
      </div>
    </div>
    <div class="form-group">
      <label for="ClasificacionEmpresa">Tamaño de la empresa:</label>
      <input name="ClasificacionEmpresa" type="text" class="form-control @error('ClasificacionEmpresa') is-invalid @enderror" 
      value="{{old('ClasificacionEmpresa', $empresa->ClasificacionEmpresa)}}" placeholder="Ej. Público" 
      disabled id="ClasificacionEmpresa">
    </div>
