...
<div class="card">
    ...
    <div class="card-body">
        <h5 class="pt-0 mt-0 mb-3 contenedor-botones text-muted">Bajas</h5>
        ...
        <div class="table-responsive-xl">
            <table class="table table-striped table-hover table-bordered" id="table_sede">
                <caption>Estudiantes dados de baja registrados en el sistema para el cohorte {{$cohorte->NombreCohorte}} clasificados
                ...
                <tbody>
                    <tr>
                        <th rowspan="3">Temporales</th>
                        @for ($i = 0; $i < $tamanioProgramas; $i++)
                            <td>Hombres: &nbsp;&nbsp;&nbsp;&nbsp;{{$informacionPorPrograma[$i]['temporal']["hombre"]}}</td>
                        @endfor
                    </tr>
                    <tr>
                        @for ($i = 0; $i < $tamanioProgramas; $i++)
                            <td>Mujeres: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$informacionPorPrograma[$i]['temporal']["mujer"]}}</td>
                        @endfor
                    </tr>
                    <tr>
                        @for ($i = 0; $i < $tamanioProgramas; $i++)
                            <td><strong>Total: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$informacionPorPrograma[$i]['temporal']["total"]}}</strong></td>
                        @endfor
                    </tr>
                    
                    <tr>
                        <th rowspan="3">Definitivos</th>
                        @for ($i = 0; $i < $tamanioProgramas; $i++)
                            <td>Hombres: &nbsp;&nbsp;&nbsp;&nbsp;{{$informacionPorPrograma[$i]['definitivo']["hombre"]}}</td>
                        @endfor
                    </tr>
                    <tr>
                        @for ($i = 0; $i < $tamanioProgramas; $i++)
                            <td>Mujeres: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$informacionPorPrograma[$i]['definitivo']["mujer"]}}</td>
                        @endfor
                    </tr>
                    <tr>
                        @for ($i = 0; $i < $tamanioProgramas; $i++)
                            <td><strong>Total: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$informacionPorPrograma[$i]['definitivo']["total"]}}</strong></td>
                        @endfor
                    </tr>
                </tbody>
            </table>
