...
<div class="card">
    ...
    <div class="card-body">
        <h5 class="pt-0 mt-0 mb-3 contenedor-botones text-muted">Reprobados</h5>
        ...
        <a class="btn btn-outline-success float-right mb-3"
            href="{{ route('cohortes.imprimirReprobadosCohorte', [$cohorte->NombreCohorte]) }}" target="_blank"
        ...
        <div class="table-responsive-xl">
            <table class="table table-striped table-hover table-bordered" id="table_periodos">
                <caption>Estudiantes reprobados clasificados por periodo registrados en el sistema para el cohorte {{$cohorte->NombreCohorte}} clasificados
                    por Programa Educativo.</caption>
                <thead class="bg-table">
                    <tr class="text-white">
