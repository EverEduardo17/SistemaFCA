...
<div class="card">
    ...
    <div class="card-body">
        <h5 class="pt-0 mt-0 mb-3 contenedor-botones text-muted">Resumen</h5>
        <h6 class="pt-0 mt-0 mb-3 contenedor-botones text-muted">Último periodo registrado: {{ $ultimoPeriodo }}</h6>
        <div class="row justify-content-center  mt-3">
            <a class="btn btn-info px-6 mb-3" href="{{ route('cohortes.mostrarResumen', [$cohorte->NombreCohorte]) }}"
        ...
        href="{{ route('cohortes.imprimirResumenCohorte', [$cohorte->NombreCohorte]) }}"
        ...
        <div class="table-responsive-xl">
            <table class="table table-striped table-hover table-bordered" id="table_sede">
                ...
                <tbody>
                    ...
                    <tr>
                        <th rowspan="3">Traslados Entrantes</th>
                        @for ($i = 0; $i < $tamanioProgramas; $i++) <td>Hombres:
                            &nbsp;&nbsp;&nbsp;&nbsp;{{$informacionPorPrograma[$i]["entranteHombre"]}}</td>
                            @endfor
                    </tr>
                    <tr>
                        @for ($i = 0; $i < $tamanioProgramas; $i++) <td>Mujeres:
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$informacionPorPrograma[$i]["entranteMujer"]}}</td>
                            @endfor
                    </tr>
                    <tr>
                        @for ($i = 0; $i < $tamanioProgramas; $i++) <td><strong>Total:
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$informacionPorPrograma[$i]["totalEntrantes"]}}</strong>
                            </td>
                            @endfor
                    </tr>

                    <tr>
                        <th rowspan="3">Traslados Salientes</th>
                        @for ($i = 0; $i < $tamanioProgramas; $i++) <td>Hombres:
                            &nbsp;&nbsp;&nbsp;&nbsp;{{$informacionPorPrograma[$i]["salienteHombre"]}}</td>
                            @endfor
                    </tr>
                    <tr>
                        @for ($i = 0; $i < $tamanioProgramas; $i++) <td>Mujeres:
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$informacionPorPrograma[$i]["salienteMujer"]}}</td>
                            @endfor
                    </tr>
                    <tr>
                        @for ($i = 0; $i < $tamanioProgramas; $i++) <td><strong>Total:
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$informacionPorPrograma[$i]["totalSalientes"]}}</strong>
                            </td>
                            @endfor
                    </tr>
